...
public class CustomersController extends BaseCrudController<Customer, CustomersViewModel> {
  ...
  public CustomersController(ServiceRegistry registry) throws SQLException {
    super(new CustomersViewModel(registry.getCustomerService()));
  }
  ...
  private void setupStaticUI() {
    ...
    // Phase 2: this.setupOrderTableColumns();
  }
  ...
  Add after Order MVVM migration is completed:
  - setupOrderTableColumns()
  - setupTableDataBinding()
  - selectedCustomerOrders in CustomerViewModel
