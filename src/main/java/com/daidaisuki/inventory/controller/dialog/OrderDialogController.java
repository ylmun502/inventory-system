...
public class OrderDialogController extends BaseDialogController<Order> {
    ...
    public void initialize() {
        ...
        actionCol.setCellFactory(TableCellUtils.createActionCellFactory(
    ...
    private void updateSaveButtonState() {
        ...
        boolean hasPaymentMethod = paymentMethodField.getText() != null && 
                                   !paymentMethodField.getText().trim().isEmpty();
    ...
    /**
     * Opens a custom dialog to edit the quantity of the specified OrderItem.
     * Performs validation and updates the quantity if valid.
     */
