 ...
 *
 * <p>This class simplifies alert creation and ensures consistent styling using a
 * shared CSS stylesheet ("styles.css"). It supports:
 * <ul>
 *   <li>Error, warning, and information alerts</li>
 *   <li>Confirmation dialogs with OK/Cancel options</li>
 *   <li>Predefined alerts for common user actions or database errors</li>
 * </ul>
 *
 * <p>All dialogs use the JavaFX {@link Alert} class and may be styled using the
 * included stylesheet. Dialogs can optionally specify an owner {@link Window}.
 *
 * <p><b>Threading Note:</b> Alerts must be created and shown on the JavaFX Application Thread.
 * The methods in this class handle thread checking internally using {@link Platform#runLater(Runnable)}.
 */
public class AlertHelper {
     ...
     *
     * <p><b>Note:</b> Confirmation dialogs must be shown on the JavaFX Application Thread.
     * If called from a background thread, this method schedules the dialog using
     * {@link Platform#runLater(Runnable)}. In such cases, synchronization may be needed
     * to retrieve the result correctly.
     *
     * @param owner   the owner window of the alert; can be {@code null}
     ...
     * @param content the alert content text
     */
    private static void showAlert(Alert.AlertType type, Window owner, String title, String header, String content) {
        Runnable showDialog = () -> {
    ...
    /**
     * Shows a warning alert indicating that a selection is required before performing the given action.
     *
