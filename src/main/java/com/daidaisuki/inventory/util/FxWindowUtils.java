 ...
 *
 * <p>This class provides methods to safely retrieve the {@link Window} from a {@link Node},
...
public final class FxWindowUtils {
   ...
   *
   * <p>If the node, its scene, or the window is {@code null}, this method will return {@code null}.
